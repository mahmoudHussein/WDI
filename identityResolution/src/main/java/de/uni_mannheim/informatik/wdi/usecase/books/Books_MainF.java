...
public class Books_MainF {
	...
	ParserConfigurationException, SAXException, IOException {
		...
		// load the data sets
				...
				engine.writeCorrespondences(correspondences, new File("usecase/books/output/Freiburg_2_GoodReads_Correspondences.csv"));
				...
				gsTraining.loadFromCSVFile(new File(
						"usecase/books/goldstandard/GS_Freiburg_GoodReads.csv"));  //name of the gold standard (IMP) change the existing its for movies
				...
				features.writeCSV(
						new File(
								"usecase/books/output/optimisation/Freiburg_2_GoodReads_Features.csv"),
						new DefaultRecordCSVFormatter());
				
				// load the gold standard (test set)
				GoldStandard gsTest = new GoldStandard();
				gsTest.loadFromCSVFile(new File(
						"usecase/books/goldstandard/GS_Freiburg_2_GoodReads_test.csv")); //name of gold standard (IMP) change the existing its for movies
